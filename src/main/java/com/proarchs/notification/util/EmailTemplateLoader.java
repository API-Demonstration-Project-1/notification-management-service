...
public class EmailTemplateLoader {
	...
	protected static Map<String, String> getTemplateMap() throws IOException {
		if (templateMap == null) {
			...
			templateMap.put(PNMSConstants.WELCOME_TEMPLATE_KEY, getHTMLContentInString(WELCOME_TEMPLATE));
			templateMap.put(PNMSConstants.POSTVERIFICATION_TEMPLATE_KEY, getHTMLContentInString(POSTVERIFICATION_TEMPLATE));
		}
	...
	private static String getHTMLContentInString(String classPath) throws IOException {
        ...
        return IOUtils.toString(inputStream, PNMSConstants.UNICODE_ENCODING_TYPE);
	}
